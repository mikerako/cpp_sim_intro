...
/// The QuadLeg - an underactuated two-link inverted pendulum. This version of
/// QuadLeg is implemented to match the dynamics of the plant specified in
...
template <typename T>
class QuadLegPlant final : public systems::MultiBodyPlant<T> {
 public:
  QuadrotorPlant();
